...
const AssignmentSchema = new mongoose_1.Schema({
    owner: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true }, // Reference to User schema
    task: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Task', required: true }, // Reference to Task schema
